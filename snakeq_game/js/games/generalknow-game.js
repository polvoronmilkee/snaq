...
generateQuestion() {
  ...
  const gkSets = {
    ...
    history: [
        ...
        { question: "Who was known as the Maid of Orléans?", correct: "Joan of Arc", wrong: ["Cleopatra", "Queen Elizabeth I", "Marie Antoinette"] },
        { question: "In what country did the Olympic Games originate?", correct: "Greece", wrong: ["Italy", "China", "Egypt"] },
        ...
        { question: "What wall fell in 1989?", correct: "Berlin Wall", wrong: ["Great Wall of China", "Hadrian’s Wall", "Western Wall"] },
        { question: "Who was the first emperor of Rome?", correct: "Augustus", wrong: ["Julius Caesar", "Nero", "Constantine"] },
        { question: "Who was the British queen during World War II?", correct: "Queen Elizabeth II", wrong: ["Queen Victoria", "Queen Elizabeth I", "Queen Mary"] },
        { question: "Who was assassinated in 1963 in Dallas, Texas?", correct: "John F. Kennedy", wrong: ["Abraham Lincoln", "Martin Luther King Jr.", "Robert Kennedy"] },
        { question: "Which empire built Machu Picchu?", correct: "Inca Empire", wrong: ["Aztec Empire", "Mayan Empire", "Roman Empire"] },
        { question: "Who invented the telephone?", correct: "Alexander Graham Bell", wrong: ["Thomas Edison", "Nikola Tesla", "James Watt"] },
        { question: "Who wrote the play 'Romeo and Juliet'?", correct: "William Shakespeare", wrong: ["Charles Dickens", "Jane Austen", "Mark Twain"] },
        { question: "Who was the first woman to fly solo across the Atlantic?", correct: "Amelia Earhart", wrong: ["Valentina Tereshkova", "Bessie Coleman", "Sally Ride"] },
        { question: "What war was fought between the North and South regions of the U.S.?", correct: "Civil War", wrong: ["World War I", "American Revolution", "Vietnam War"] },
        { question: "Who painted the Mona Lisa?", correct: "Leonardo da Vinci", wrong: ["Michelangelo", "Raphael", "Donatello"] },
        { question: "What ship sank after hitting an iceberg in 1912?", correct: "Titanic", wrong: ["Britannic", "Olympic", "Lusitania"] },
        { question: "Who was the first emperor of China?", correct: "Qin Shi Huang", wrong: ["Sun Yat-sen", "Mao Zedong", "Confucius"] },
        { question: "Which country gifted the Statue of Liberty to the USA?", correct: "France", wrong: ["England", "Spain", "Germany"] },
        { question: "Who was the first African-American president of the USA?", correct: "Barack Obama", wrong: ["Martin Luther King Jr.", "Colin Powell", "Jesse Jackson"] },
    ],
