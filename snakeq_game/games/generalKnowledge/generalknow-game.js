...
class SnakeGeneralKnowledgeGame {
    ...
    initSpeedControl() {
        ...
        this.speedControlButton.addEventListener('click', () => {
            ...
            if (!isExpanded) {
                // Show then force reflow so transition applies
                ...
                // Collapse and hide after transition
                this.speedSliderContainer.classList.remove('expanded');
                this.speedControlButton.classList.remove('expanded');
                // hide after transition (match CSS transition + buffer)
                setTimeout(() => {
                    this.speedSliderContainer.style.display = 'none';
                }, 360);
            }
    ...
    showGameOver() {
        ...
        if (this.gameOverTitle && this.finalScoreElement && this.gameOverOverlay) {
            ...
            if (username && window.LeaderboardManager) {
                ...
                leaderboardManager.submitScore(username, this.score, 'generalknow');
            }
    ...
    // Submit game statistics for achievement tracking
    submitGameStatistics() {
        ...
        console.log('=== GENERAL KNOWLEDGE GAME STATISTICS SUBMISSION ===');
