  ...
  getShopItemsByCategory(category) {
    const items = {
      skins: [
        ...
        { id: 'pink', name: 'Sugar Rush', desc: 'The saccharine snake in strawberry', price: 100 },
        { id: 'blue', name: 'Ocean Fang', desc: 'The cold blooded snake', price: 100 },
        { id: 'purple', name: 'Midnight Mirage', desc: 'A mysterious purple snake', price: 150 },
        { id: 'gold', name: 'Royal Glimmer', desc: 'A royalty shining snake', price: 150 },
        { id: 'gray', name: 'Scarred Shadow', desc: 'A mysterious snake above the gray fog', price: 250 },
        { id: 'robin', name: 'Robin', desc: 'Sidekick of Batman', price: 250 },
        { id: 'white', name: 'Crimson Pale', desc: 'A pale vampire-like snake', price: 300 },
        { id: 'volt', name: 'Ghost Shock', desc: 'A ghostly snake with shock energy', price: 500 },
        { id: 'centipede', name: 'Bore Centipede', desc: 'Mortal enemy of SnaQ, BEWARE!!', price: 1000 },
      ],
      accessories: [
      ...
      tiles: [
        ...
        { id: 'pinkTile', name: 'Sugar Rush', desc: 'Choco-yumm!!', price: 100 },
        ...
        { id: 'bananachocTile', name: 'Choco Banana Waffle', desc: 'A yummy choco-chip banana waffle', price: 100 },
    ...
    return [
      {
        ...
        icon: '<img src="./assets/images/apples/apple.png" class="achievement-icon">',
        reward: 150,
      ...
      },
      {
        ...
        icon: '<img src="./assets/images/icons/speed-icon.png" class="achievement-icon speed-icon">',
        reward: 250,
      ...
      },
      {
        ...
        icon: '<img src="./assets/images/icons/scholar-icon.png" class="achievement-icon scholar-icon">',
        reward: 350,
      ...
      },
      {
        ...
        icon: '<img src="./assets/images/icons/leaderboard-icon.png" class="achievement-icon scholar-icon">',
        reward: 200,
      ...
      },
      {
        ...
        icon: '<img src="./assets/images/icons/pixelPalette.png" class="achievement-icon speed-icon">',
        reward: 300,
      ...
      },
      {
        ...
        icon: '<img src="./assets/images/icons/clock-icon.png" class="achievement-icon scholar-icon">',
        reward: 500,
